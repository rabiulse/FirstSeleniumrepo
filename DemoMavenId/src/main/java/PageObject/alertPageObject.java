...
public class alertPageObject extends BaseTest {
	...
	//private WebElement javaScriptAlert=driver.findElement(By.xpath("//a[normalize-space()='JavaScript Alerts']"));
	 //private By javaScriptAlert = By.xpath("//a[normalize-space()='JavaScript Alerts']");
	//private WebElement ClickForJsAlert=driver.findElement(By.xpath("//button[normalize-space()='Click for JS Alert']"));
	//private WebElement validateResult=driver.findElement(By.xpath("//*[@id=\"result\"]"));
